            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">AMINE STORE</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Adventure starts here 🚀</h4>
              <p class="mb-4">Make your app management easy and fun!</p>
              <form id="formAuthentication" class="mb-3" action="/ajoute_register" method="POST">
                @csrf
                <div class="mb-3">
              ...
              @enderror
                ...
                <button id="alertButton" type="submit"  href="/login" class="btn btn-primary d-grid w-100">Sign up</button>
              </form>
