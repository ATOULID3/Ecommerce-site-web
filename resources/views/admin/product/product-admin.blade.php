              ...
              <div class="col-sm-6 col-lg-3">
                <div class="d-flex justify-content-between align-items-start card-widget-1 border-end pb-4 pb-sm-0">
                  <div>
                    ...
                    <p class="mb-0">Products: <strong>120</strong></p> <!-- Product count -->
                  </div>
                  <span class="avatar me-sm-6">
                    <span class="avatar-initial rounded w-px-44 h-px-44">
                      <i class="bx bx-store-alt bx-lg text-heading"></i> <!-- Store icon -->
                    </span>
                  </span>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="d-flex justify-content-between align-items-start card-widget-2 border-end pb-4 pb-sm-0">
                  <div>
                    ...
                    <p class="mb-0">Products: <strong>320</strong></p> <!-- Product count -->
                  </div>
                  <span class="avatar p-2 me-lg-6">
                    <span class="avatar-initial rounded w-px-44 h-px-44">
                      <i class="bx bx-laptop bx-lg text-heading"></i> <!-- Laptop icon -->
                    </span>
                  </span>
                </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="d-flex justify-content-between align-items-start border-end pb-4 pb-sm-0 card-widget-3">
                  <div>
                    ...
                    <p class="mb-0">Products: <strong>85</strong></p> <!-- Product count -->
                  </div>
                  <span class="avatar p-2 me-sm-6">
                    <span class="avatar-initial rounded w-px-44 h-px-44">
                      <i class="bx bx-gift bx-lg text-heading"></i> <!-- Gift icon -->
                    </span>
                  </span>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="d-flex justify-content-between align-items-start">
                  <div>
                    ...
                    <p class="mb-0">Products: <strong>50</strong></p> <!-- Product count -->
                  </div>
                  <span class="avatar p-2">
                    <span class="avatar-initial rounded w-px-44 h-px-44">
                      <i class="bx bx-wallet bx-lg text-heading"></i> <!-- Wallet icon -->
                    </span>
                  </span>
                </div>
              </div>
